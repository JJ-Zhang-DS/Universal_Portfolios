"""Phase 5: modern out-of-sample -- real historical price data.
...
configured pair, and plots the rolling QQQ/TLT and WM/TSLA correlation
against the 2020 and 2022 crisis windows.
...
from universal_portfolio.plotting import plot_real_pair_results, plot_rolling_correlation
from universal_portfolio.real_data_experiments import backtest_all_pairs, rolling_correlation
